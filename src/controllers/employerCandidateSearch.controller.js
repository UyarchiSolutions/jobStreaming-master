...
const create_saved_folder = catchAsync(async (req, res) => {
  const user = await employerCandidateSearch.create_saved_folder(req)
  res.send(user)

})

const existing_saved_folder = catchAsync(async (req, res) => {
  const user = await employerCandidateSearch.existing_saved_folder(req)
  res.send(user)

})

const get_my_folder = catchAsync(async (req, res) => {
  const user = await employerCandidateSearch.get_my_folder(req)
  res.send(user)
...
const get_saved_candidate= catchAsync(async (req, res) => {
  const user = await employerCandidateSearch.get_saved_candidate(req)
  res.send(user)
