...
router.route('/').post(upload.none(),adminAskController.createfaqe);
...
router.route('/get_Faqe_update/:id').put(upload.none(), adminAskController.get_Faqe_update);
...
router.route('/create_enquiry_dummy').post(upload.none(), adminAskController.create_enquiry_dummy);
router.route('/get_Enquiry_update/:id').put(upload.none(), adminAskController.get_Enquiry_update);
